...
| Notebook 3 — So What Do I Do Monday? | Evaluation framework, group exercise, take-home prompt | Hour 3 |

## API Key

The API key will be shared during the live session. In the first code cell of each notebook, replace:
...
Fabrice Theodore, CPEng NER MIEAust
Director and Founder, Allayze
[allayze.com](https://allayze.com.au)
